        ...
        <Asset>
          {isLoading ? (
            ...
            assets.map((value, key) => {
              return (
                <AssetsCard key={key}>
                  {value.image_preview_url || value.image ? (
                    <ImageDiv>
                      <Image
                        src={
                      ...
                      <AssetInfo>
                        <IconButton>
                          <ALink
                            href={
                              value.token_id
                                ? `https://opensea.io/assets/0x3cd41ec039c1f2dd1f76144bb3722e7b503f50ab/${value.token_id}`
                                : `https://opensea.io/assets/${value.contract_address}/${value.assetId}`
                            }
                            target="_blank"
                          >
                      ...
                      <AssetInfo>
                        <IconButton>
                          <ALink
                            href={
                              value.token_id
                                ? `https://rarible.com/token/0x3cd41ec039c1f2dd1f76144bb3722e7b503f50ab:${value.token_id}`
                                : `https://rarible.com/token/${value.contract_address}:${value.assetId}`
                            }
                            target="_blank"
                          >
                            <RaribleIcon>
